...
module.exports = {
    data: new d.SlashCommandBuilder()
        ...
        .setNameLocalizations({
            fr: "étudier-imparfait",
            nl: "studie-ovt",
        })
        .setDescription("Study the past participle off an irregual verb.")
        .setDescriptionLocalizations({
            fr: "Etudie l'imparfait d'un verbe irrégulier.",
            nl: "Leer het ontegenwoordige tijd van een werkwoord.",
        })
    ...
    async execute(interaction) {
        ...
        const message = await channel.send({ 
            content: `${language(guild, "VERB_ANSW").replace("{0}", "l' imparfait").replace("{1}", verbList.verbs[randomVerb][0])}`,
        ...
        if (submitted) {
            ...
            const participle = submitted.fields.getTextInputValue('impfInput');

            let similarity = modules.CompareStrings(verbList.verbs[randomVerb][1], participle.toLowerCase())
            ...
            // If answer is incorrect
                ...
                submitted.reply(`${member} ${language(guild, "LOSE_XP")} 3 points ! ${language(guild, "ANSWER_WAS")} ${verbList.verbs[randomVerb][1]}`);
                message.edit({
                    content: `${language(guild, "THX_ANSW")}`,
                    components: [],
                })
        ...
        // If user doesn't answer
            ...
            message.edit({
                content: `${member}, ${language(guild, "QST_OUTDATED_1")} 3 ${language(guild, "QST_OUTDATED_2")} ${verbList.verbs[randomVerb][1]}`,
                components: [],
            })
